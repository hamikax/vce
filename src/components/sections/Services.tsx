...
const Services = () => {
  const services = [
    {
      title: "البناء",
      description: "من المباني السكنية إلى المجمعات التجارية، نتعامل مع مشاريع البناء بجميع أحجامها بدقة واهتمام.",
      icon: (
    ...
    {
      title: "الهندسة",
      description: "يصمم فريقنا من المهندسين الخبراء حلولًا مبتكرة وظيفية وجمالية في آن واحد.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "نشرف على المشاريع من التصور إلى الإكمال، مما يضمن بقاءها على الجدول الزمني وضمن الميزانية.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: "الصيانة",
      description: "نقدم خدمات صيانة مستمرة لضمان طول عمر المباني والهياكل وعملها.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <section id="services" className="vce-section">
      <div className="vce-container">
        <h2 className="vce-heading text-center">خبرات VCE</h2>
